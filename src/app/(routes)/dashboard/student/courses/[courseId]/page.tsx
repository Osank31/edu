                ...
                {course ? (
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-6 mt-6 text-sm text-slate-500">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span>{course.studentsId.length} Students Enrolled</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="bg-slate-50 rounded-lg p-6">
                                {course.sections && course.sections.length > 0 ? (
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-slate-600">Course content will appear here once it's added by your instructor.</p>
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="min-h-[60vh] flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-slate-600">This course might not exist or you don't have access to it.</p>
                        </div>
                    </div>
                )}
            </div>
