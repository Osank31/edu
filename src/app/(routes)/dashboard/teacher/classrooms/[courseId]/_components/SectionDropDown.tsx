                                                    ...
                                                    {section.lectures.map(
                                                        (lecture, lectureIndex) => (
                                                            <div
                                                                ...
                                                                onClick={() => {
                                                                    router.push(
                                                                        `/dashboard/teacher/classrooms/${courseId}/sections/${section.id}/lectures/${lecture.id}`
                                                                    );
                                                                }}
                                                            >
                                                                <div className="flex-shrink-0">
                                                                ...
                                                                <div className="flex-shrink-0">
                                                                    ...
                                                                    >
                                                                        <path
                                                                            ...
                                                                            strokeLinejoin="round"
                                                                            strokeWidth={2}
                                                                            d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293H15M9 10v4h4m-4-4v0m4 4v0"
                                                                        />
                                                                    </svg>
                                                                </div>
                                                            </div>
