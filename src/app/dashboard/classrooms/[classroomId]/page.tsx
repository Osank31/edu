        ...
        {data ? (
          ...
          <div className="min-h-[60vh] flex items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">No Course Data Found</h3>
              <p className="text-slate-600">This classroom might not exist or you don't have access to it.</p>
            </div>
          </div>
        )}
      </div>
